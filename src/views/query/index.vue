  ...
  <d2-container>
    ...
    <el-container>
      <el-aside width="200px" style="background-color: rgb(238, 241, 246);height:100%;">
        <!-- <el-tree lazy :load="loadNode" :props="defaultProps" accordion style="font-size:20px"></el-tree> -->
        <el-tree :data="data" :props="defaultProps" style="font-size:20px"></el-tree>
      </el-aside>
      <el-container>
        <el-header>
        ...
        <el-footer>
          <el-table style="width: 100%" border :data="tableData">
            <template v-for="item in tableHead">
              <el-table-column :prop="item.label" :label="item.label" :key="item.id"></el-table-column>
            </template>
          </el-table>
        </el-footer>
      </el-container>
